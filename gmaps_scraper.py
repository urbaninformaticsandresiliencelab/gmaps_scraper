...
def scrape_subdivisions(options):
    ...
    if (options.type == "places_nearby"):
        new_scraper = PlacesNearbyScraper(scraper_output_directory_name)
    elif (options.type == "places_radar"):
        new_scraper = PlacesRadarScraper(scraper_output_directory_name)
...
def scrape_details(options):
    ...
    details = DetailScraper("%s_%s_details" % (
        time.strftime("%Y-%m-%d"),
        options.details
...
if (__name__ == "__main__"):
    ...
    if (options.rescrape != "null"):
        scrape_errors(options)
    elif (options.details != "null"):
